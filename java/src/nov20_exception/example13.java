...
try {
      result=num1/num2;//abnormal// this will inform JVM that its end of the program, so terminate the executionl statement, which will terminate the program execution
        System.out.println("result:"+result );
		Thread.sleep(5000);
// exeption is show after 5 sec 
        
        //
}catch   (ArithmeticException | InterruptedException e ) {//when you are  sure about exception type coming from try block use 
